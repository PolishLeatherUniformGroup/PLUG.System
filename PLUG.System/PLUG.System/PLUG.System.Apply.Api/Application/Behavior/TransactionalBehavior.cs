...
namespace PLUG.System.Apply.Api.Application.Behavior;
    ...
    where TResult : CommandResult
{
    ...
    public TransactionalBehavior(ApplyContext context, IIntegrationEventService integrationEventService, ILogger<TransactionalBehavior<TCommand, TResult>> logger)
    {
