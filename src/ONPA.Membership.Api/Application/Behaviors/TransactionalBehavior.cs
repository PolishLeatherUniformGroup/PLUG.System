...
namespace ONPA.Membership.Api.Application.Behaviors;
    ...
    where TResult : CommandResult
{
    ...
    public TransactionalBehavior(MembershipContext context, IIntegrationEventService integrationEventService, ILogger<TransactionalBehavior<TCommand, TResult>> logger)
    {
