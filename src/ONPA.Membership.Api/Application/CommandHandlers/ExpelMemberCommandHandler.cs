...
public sealed class ExpelMemberCommandHandler : MultiTenantApplicationCommandHandlerBase<ExpelMemberCommand>
{
    private readonly IMultiTenantAggregateRepository<Member> _aggregateRepository;

    public ExpelMemberCommandHandler(IMultiTenantAggregateRepository<Member> aggregateRepository)
    {
