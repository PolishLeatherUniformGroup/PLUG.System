...
public sealed class AcceptSuspensionAppealCommandHandler : MultiTenantApplicationCommandHandlerBase<AcceptSuspensionAppealCommand>
{
    private readonly IMultiTenantAggregateRepository<Member> _aggregateRepository;

    public AcceptSuspensionAppealCommandHandler(IMultiTenantAggregateRepository<Member> aggregateRepository)
    {
