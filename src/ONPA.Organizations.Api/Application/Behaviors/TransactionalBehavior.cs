    ...
    where TResult : CommandResult
{
    ...
    public TransactionalBehavior(OrganizationsContext context, IIntegrationEventService integrationEventService, ILogger<TransactionalBehavior<TCommand, TResult>> logger)
    {
