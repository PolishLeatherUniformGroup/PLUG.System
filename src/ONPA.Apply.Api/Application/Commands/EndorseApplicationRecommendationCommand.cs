...
public sealed record EndorseApplicationRecommendationCommand(Guid ApplicationFormId, Guid RecommendationId,Guid RecommendingMemberId) : ApplicationCommandBase
{
